...
//    private static final Logger logger = LoggerFactory.getLogger(FlinkUtil.class);
    ...
    public static void registerUDF(String type, String classPath, String funcName, TableEnvironment tableEnv,
        ...
        if("SCALA".equalsIgnoreCase(type)){
            ...
            registerTableUDAF(classPath, funcName, tableEnv, classLoader);
        }else{
     ...
     * @param tableEnv
     */
    public static void registerTableUDAF(String classPath, String funcName, TableEnvironment tableEnv,
                                         ClassLoader classLoader){
        try {
         ...
         //   logger.error("", e);
            throw new RuntimeException("register Table UDAF exception:" + e.getMessage());
        }
    }
