...
public class PerJobClusterClientBuilder {
    ...
    public AbstractYarnClusterDescriptor createPerJobClusterDescriptor(Properties confProp, String flinkJarPath, String queue,String applicationName) throws MalformedURLException {
        ...
        //TODO 设置YARN界面任务名
        clusterDescriptor.setName(applicationName);
