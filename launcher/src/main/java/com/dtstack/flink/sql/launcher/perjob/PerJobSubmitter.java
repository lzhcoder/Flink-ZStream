...
public class PerJobSubmitter {
    ...
    public static String submit(LauncherOptions launcherOptions, JobGraph jobGraph) throws Exception {
        ...
        AbstractYarnClusterDescriptor yarnClusterDescriptor = perJobClusterClientBuilder.createPerJobClusterDescriptor(confProperties, flinkJarPath, launcherOptions.getQueue(),launcherOptions.getName());
        System.out.println("任务参数："+confProperties.toString());
        ...
        String tips = String.format("applicationID: %s, jobId: %s", applicationId, "application_job_id_"+flinkJobId);
